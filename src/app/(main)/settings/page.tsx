...
import type { Department, ConnectionSpeed, SettingItem } from "@/lib/types";
...
type SettingType = 'departments' | 'speeds';
...
export default function SettingsPage() {
    ...
    const [isLoading, setIsLoading] = useState<Record<SettingType, boolean>>({
        departments: true,
        // blocks: true,
        speeds: true
    });
