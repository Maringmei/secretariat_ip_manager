        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)}>
                <DialogHeader>
                    ...
                    <DialogDescription>Please provide a reason for reverting this request. The request will be moved to the rejected list.</DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-6">
                    <FormField control={form.control} name="remark" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Textarea placeholder="Explain why this request is being reverted..." {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}/>
